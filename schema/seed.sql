...
--        ('web:masterdata:supplier:edit', 'web:masterdata:supplier', 'Perbarui Data Supplier', 2, '/api/supplier/find;/api/supplier/edit;/api/auth/check'),
       ...
       ('web:price:buy:manage', 'web:price:buy', 'Kelola Harga Beli', 0, '/api/unit/find;/api/unit/edit;/api/unit/create;/api/supplier/find;/api/product/find;/api/supplier/add-price;/api/supplier/find-latest-price;/api/supplier/find-price'),
       ('web:price:sell:manage', 'web:price:sell', 'Kelola Harga Jual', 0, '/api/unit/find;/api/unit/edit;/api/unit/create;/api/customer/find;/api/product/find;/api/customer/add-price;/api/customer/find-latest-price;/api/customer/find-price'),
