...
--        ('web:masterdata:supplier:edit', 'web:masterdata:supplier', 'Perbarui Data Supplier', 2, '/api/supplier/find;/api/supplier/edit;/api/auth/check'),
       ...
       ('web:price:template:manage', 'web:price:template', 'Template Harga', 3, '/api/customer/findActive;/api/product/findActive;/api/price/template/find;/api/price/template/create;/api/price/template/edit-price;/api/price/template/apply;/api/price/template/findDetail'),
       ...
       ('web:transaction:status:managestatus', 'web:transaction:status', 'Perbarui Status Penjualan', 1, '/api/transaction/find;/api/transaction/updateStatus;/api/transaction/updateBuyPrice'),
